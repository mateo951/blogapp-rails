...
RSpec.describe 'Posts', type: :request do
  describe 'GET /users/1/posts' do
    ...
    it 'shows the correct placeholder text in index' do
      expect(response.body).to include('<p>Find me in app/views/posts/index.html.erb</p>')
    end
  end
  describe 'GET /users/:id/posts/:id' do
    ...
    it 'shows the correct placeholder text in show' do
      expect(response.body).to include('<p>Find me in app/views/posts/show.html.erb</p>')
    end
